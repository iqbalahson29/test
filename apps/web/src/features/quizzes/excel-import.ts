...
export function downloadQuestionsTemplate(filename = 'questions-import-template') {
  const workbook = XLSX.utils.book_new()
  const sheet = XLSX.utils.aoa_to_sheet([HEADER_ROW, ...EXAMPLE_ROWS])
...
/** Parses an uploaded questions workbook (see downloadQuestionsTemplate for the expected format). */
export function parseQuestionsExcel(buffer: ArrayBuffer): ExcelImportResult {
