...
export function PracticeQuizPrintView() {
                    ...
                    {q.imageKey && (
                      <div className="mt-2">
                        <DocumentViewer
                          ...
                          path={practiceQuestionsApi.imageUrlPath(quiz.id, q.id)}
                        />
                      </div>
                    )}
                    {q.options.length > 0 && (
                          ...
                          >
                            ...
                            {o.imageKey && (
                              <DocumentViewer
                                ...
                                path={practiceQuestionsApi.optionImageUrlPath(quiz.id, q.id, o.id)}
                                imageThumbnail
                              />
                            )}
                          </li>
