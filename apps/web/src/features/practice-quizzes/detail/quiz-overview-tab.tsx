...
export function QuizOverviewTab({
  ...
  const { data: summary } = useQuery({
    queryKey: ['practice-assignment-summary', quiz.id],
    queryFn: () => practiceAssignmentsApi.summary(quiz.id),
  })
  const { data: activity, isLoading: activityLoading } = useQuery({
    queryKey: ['practice-quiz-activity', quiz.id],
    queryFn: () => practiceQuizzesApi.activity(quiz.id),
  })
