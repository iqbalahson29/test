          ...
          <>
            ...
            {question.attachmentKey && (
              <DocumentViewer
                ...
                path={practiceQuestionsApi.attachmentUrlPath(quizId, question.id)}
              />
            )}
            ...
            {question.imageKey && (
              <DocumentViewer
                ...
                path={practiceQuestionsApi.imageUrlPath(quizId, question.id)}
              />
            )}
                  ...
                  >
                    ...
                    {o.imageKey && (
                      <DocumentViewer
                        ...
                        path={practiceQuestionsApi.optionImageUrlPath(quizId, question.id, o.id)}
                        imageThumbnail
                      />
                    )}
                  </li>
