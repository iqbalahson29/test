...
export function McqSingleAnswer({ question, value, onChange, readOnly, attemptId }: AnswerInputProps) {
        ...
        <Label key={o.id} className="flex items-center gap-2 font-normal">
          ...
          {o.imageFilename && (
            <DocumentViewer
              ...
              path={`/practice-attempts/${attemptId}/questions/${question.id}/options/${o.id}/image-url`}
              imageThumbnail
            />
          )}
        </Label>
