...
import { groupByBucket } from '../practice-assignments/bucket'
import { UpcomingCalendar } from '../practice-attempts/upcoming-calendar'
import { RecentActivity } from '../practice-attempts/recent-activity'
...
export function StudentPracticeAnalyticsPage() {
  ...
  const onJump = (assignmentId: string) => {
    navigate('/student/practice-quizzes', { state: { jumpTo: assignmentId } })
  }
            ...
            <TableBody>
              ...
              {pageAttempts.map((a: MyAttemptAnalytics) => (
                <TableRow
                  ...
                  onClick={() => navigate(`/student/practice-attempts/${a.attemptId}`)}
                >
