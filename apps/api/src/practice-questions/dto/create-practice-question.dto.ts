...
import { PracticeQuestionOptionDto } from './practice-question-option.dto';
...
export class CreatePracticeQuestionDto {
  ...
  // schemas in PracticeQuestionsService, not here.
  @IsObject()
  ...
  // image content type) and PUTting the file to S3 — see PracticeQuestionsService.
  @IsOptional()
  @IsString()
  imageKey?: string;
